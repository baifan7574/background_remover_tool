...
DEV_TOKEN = "dev-token-test-user-123"  # 开发测试token
...
def create_test_user():
    ...
    try:
        ...
        user_data = {
            ...
            "plan": "pro",  # 使用专业版避免次数限制
            "created_at": datetime.now().isoformat(),
            "updated_at": datetime.now().isoformat()
        }
        
        # 这里应该通过API创建用户，但为了测试，我们直接使用token
        print(f"🔑 使用开发token: {DEV_TOKEN}")
        return True
